...
export function Factory(): ClassDecorator {
    return function <FactoryFunction extends Function>(
...
export function FactoryProduct<FactoryFunction extends Function>(
    factoryClass: FactoryFunction
): ClassDecorator {
    return function <ProductFunction extends Function>(
        constructor: ProductFunction
    ) {
